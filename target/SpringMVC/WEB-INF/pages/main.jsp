...
<head>
    ...
    <link rel="stylesheet" href=<c:url value="/resourses/css/style-main.css"/> />
...
<main>
    <div class="container_12">
        <div class="grid_6">
            <div class="load_control">
                <span>Load Control</span>
                <a href="modes"><div class="light_center">
                    <i class="fa fa-lightbulb-o"></i>
                </div>
                    <form class="form-container" action="modes">
        ...
        <div class="grid_6">
            <div class="graphs">
                <span>Graphs</span>
                <a href="graphs"><i class="fa fa-area-chart"></i>
                    <form class="form-container" action="graphs">
                        <div class="submit-container">
                            <input class="submit-button" type="submit" value="SEE"/>
                        </div>
                    </form></a>
            </div>
        </div>
